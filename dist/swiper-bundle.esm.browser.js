...
function updateSlides() {
  ...
  if (rtl && wrongRTL && (params.effect === 'slide' || params.effect === 'coverflow' || params.effect === 'panorama')) {
    $wrapperEl.css({
...
var defaults = {
  ...
  // Effects
  effect: 'slide',
  // 'slide' or 'fade' or 'cube' or 'coverflow' or 'flip' or 'panorama'
  // Breakpoints
...
// Swiper Class
const modules = [Virtual, Keyboard, Mousewheel, Navigation, Pagination, Scrollbar, Parallax, Zoom, Lazy, Controller, A11y, History, HashNavigation, Autoplay, Thumb, freeMode, Grid, Manipulation, EffectFade, EffectCube, EffectFlip, EffectCoverflow, EffectCreative, EffectCards, EffectPanorama];
Swiper.use(modules);
